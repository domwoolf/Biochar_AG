...
The model assumes a fixed cost per unit mass of Co2 for storage injection with default values of \$12 Mg-1 for onshore and \$40 Mg-1 for offshore storage [@ref].
...
-   **BEBCS:** Abatement combines the grid displacement credit with the permanent CO~2~ equivalent of the biochar carbon retained in the soil ($F_{perm}$).
